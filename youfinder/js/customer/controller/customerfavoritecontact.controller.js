(function () {
    ...
    var customerFavoriteContactController = function ($scope, customer, CustomerService, UIAnimationService, category, Utils) {
    ...
    app.controller('CustomerFavoriteContactController', customerFavoriteContactController);
